...
void testMagnitudeAndPhase()
{
    ...
    ComplexNumber c1(3, 4), c2(-3), c3(-3, 4), c4(-3, -4), c5(3, -4);
    double magnitudeResult = 5;
    if (c1.magnitude() == magnitudeResult) {
        cout << "Magnitude test passed" << endl;
    }
    double phaseResult1 = 0.927295, phaseResult3 = 2.214297,
           phaseResult4 = -2.214297, phaseResult5 = -0.927295;
    if (c1.phase() - phaseResult1 < 0.000001 &&
        c3.phase() - phaseResult3 < 0.000001 &&
        c4.phase() - phaseResult4 < 0.000001 &&
        c5.phase() - phaseResult5 < 0.000001 && c2.phase() == M_PI) {
