...
void testRegularOperators(){
    ...
    ComplexNumber additionResult(7, 9), substractionResult(-1, -1), multiplicationResult(-8, 31), multiplicationByNumberResult(6, 8), divisionResult(32.0/41.0, (1.0/41.0)), divisionByNumberResult(1.5, 2);
    c3 = c1 + c2;
...
void testMagnitudeAndPhase(){
    ...
    cout << "c1.phase() = " << phaseResult << ", calculator result = "<< c1.phase() << endl;
